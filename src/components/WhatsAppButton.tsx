...
export default function WhatsAppButton({
  ...
  const handleClick = () => {
    ...
    trackGoogleAdsConversion(
      import.meta.env.VITE_GOOGLE_ADS_CONVERSION_LABEL_WHATSAPP,
      {
  ...
  return (
    <a
      ...
      className={`${styles.whatsappButton} ${isCookieBannerVisible ? styles.aboveCookieBanner : ""} ${hideOnMobile ? styles.hideOnMobile : ""}`}
      onClick={handleClick}
